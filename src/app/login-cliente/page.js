...
export const metadata = {
  title: "Login da clínica | Clinica SaaS",
};
    ...
    <main className="grid min-h-screen bg-[#f7f7f4] text-neutral-950 lg:grid-cols-[1fr_520px]">
      <section className="hidden min-h-screen flex-col justify-between border-r border-neutral-200 bg-white p-10 lg:flex">
        ...
        <div className="max-w-xl">
          <p className="text-xs font-bold uppercase tracking-[0.22em] text-emerald-700">Área da clínica</p>
          <h1 className="mt-4 text-5xl font-semibold tracking-tight">Entre para operar sua clínica.</h1>
          <p className="mt-5 text-sm leading-7 text-neutral-600">Acesso para recepção, gestores, profissionais e financeiro visualizarem a operação da clínica com identidade própria.</p>
          <div className="mt-8 grid gap-3">
            <div className="rounded-lg border border-neutral-200 p-4"><CalendarCheck className="text-emerald-700" size={22} /><p className="mt-3 text-sm leading-6 text-neutral-600">Agenda, clientes, prontuário, financeiro e assinatura em um só painel.</p></div>
            <div className="rounded-lg border border-neutral-200 p-4"><Palette className="text-emerald-700" size={22} /><p className="mt-3 text-sm leading-6 text-neutral-600">Quando a clínica tiver logo e cores no cadastro, o dashboard assume essa identidade visual.</p></div>
          </div>
        </div>
        <Link href="/login" className="text-sm font-semibold text-neutral-600 hover:text-neutral-950">Sou administrador interno</Link>
      </section>
      ...
      <section className="flex min-h-screen items-center justify-center px-5 py-10 sm:px-8">
        <div className="w-full max-w-md">
          ...
          <div className="rounded-lg border border-neutral-200 bg-white p-6 shadow-sm sm:p-7">
            ...
            <p className="mt-5 text-xs font-bold uppercase tracking-[0.22em] text-emerald-700">Área da clínica</p>
            <h2 className="mt-2 text-2xl font-semibold tracking-tight">Entrar no dashboard</h2>
