...
const company = {
  ...
  contactEmail: "privacidade@seudominio.com.br",
  commercialEmail: "contato@seudominio.com.br",
  ...
  return (
    <main className="min-h-screen bg-[#f7f7f4] px-5 py-10 text-neutral-950 sm:px-8 lg:px-10">
      <section className="mx-auto max-w-3xl rounded-lg border border-neutral-200 bg-white p-6 shadow-sm sm:p-8">
        ...
        <p className="mt-4 text-sm leading-7 text-neutral-600">Este texto e uma base operacional para demonstracao. Antes da venda em producao, substitua os dados empresariais abaixo e submeta a revisao juridica.</p>
        ...
        <p className="mt-8 rounded-lg bg-amber-50 p-4 text-sm leading-7 text-amber-900">Pendente antes da comercializacao: revisar juridicamente responsabilidades entre plataforma, clinica contratante e titulares dos dados.</p>
      </section>
    </main>
  );
}
